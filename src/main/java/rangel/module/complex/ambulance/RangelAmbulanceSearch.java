...
public class RangelAmbulanceSearch extends Search {
  ...
  public RangelAmbulanceSearch(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
