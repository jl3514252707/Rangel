...
public class RangelAmbulanceHumanDetector extends HumanDetector {
    ...
    public RangelAmbulanceHumanDetector(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
    ...
    private EntityID calcTargetInCluster(Clustering clustering) {
        ...
        Collection<
                StandardEntity> elements = clustering.getClusterEntities(clusterIndex);
