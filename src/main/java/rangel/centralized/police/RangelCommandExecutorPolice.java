...
public class RangelCommandExecutorPolice extends CommandExecutor<CommandPolice> {
  ...
  public RangelCommandExecutorPolice(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
