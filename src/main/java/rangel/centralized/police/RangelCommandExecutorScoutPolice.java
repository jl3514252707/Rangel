...
public class RangelCommandExecutorScoutPolice
  ...
  public RangelCommandExecutorScoutPolice(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
    ...
    switch (scenarioInfo.getMode()) {
      ...
      case NON_PRECOMPUTE:
        this.pathPlanning = moduleManager.getModule(
            "RangelCommandExecutorScoutPolice.PathPlanning",
            "adf.impl.module.algorithm.DijkstraPathPlanning");
        this.actionExtClear = moduleManager.getExtAction(
            "RangelCommandExecutorScoutPolice.ExtActionClear",
