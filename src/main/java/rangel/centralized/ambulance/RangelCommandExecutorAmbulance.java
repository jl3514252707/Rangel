...
public class RangelCommandExecutorAmbulance extends CommandExecutor<CommandAmbulance> {
    ...
    public RangelCommandExecutorAmbulance(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
