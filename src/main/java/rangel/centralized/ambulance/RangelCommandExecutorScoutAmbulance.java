...
public class RangelCommandExecutorScoutAmbulance extends CommandExecutor<CommandScout> {
  ...
  public RangelCommandExecutorScoutAmbulance(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
    ...
    switch (scenarioInfo.getMode()) {
      ...
      case NON_PRECOMPUTE:
        this.pathPlanning = moduleManager.getModule(
            "RangelCommandExecutorScoutAmbulance.PathPlanning",
