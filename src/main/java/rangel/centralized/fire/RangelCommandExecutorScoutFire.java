...
public class RangelCommandExecutorScoutFire extends CommandExecutor<CommandScout> {
  ...
  public RangelCommandExecutorScoutFire(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
    ...
    switch (scenarioInfo.getMode()) {
      ...
      case NON_PRECOMPUTE:
        this.pathPlanning = moduleManager.getModule(
            "RangelCommandExecutorScoutFire.PathPlanning",
