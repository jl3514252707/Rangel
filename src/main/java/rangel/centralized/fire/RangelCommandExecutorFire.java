...
public class RangelCommandExecutorFire extends CommandExecutor<CommandAmbulance> {
  ...
  private ExtAction actionExtRescue;
  ...
  public RangelCommandExecutorFire(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
    ...
    switch (scenarioInfo.getMode()) {
      ...
      case NON_PRECOMPUTE:
        this.pathPlanning = moduleManager.getModule(
            "RangelCommandExecutorFire.PathPlanning",
            "adf.impl.module.algorithm.DijkstraPathPlanning");
        this.actionExtRescue = moduleManager.getExtAction(
            "RangelCommandExecutorFire.ExtActionRescue",
            "adf.impl.extaction.DefaultExtActionFireRescue");
        this.actionExtMove = moduleManager.getExtAction(
            "RangelCommandExecutorFire.ExtActionMove",
  ...
  public CommandExecutor calc() {
    ...
    switch (this.commandType) {
      ...
      case ACTION_RESCUE:
        if (this.target != null) {
          this.result = this.actionExtRescue.setTarget(this.target).calc()
              .getAction();
        }
        return this;
